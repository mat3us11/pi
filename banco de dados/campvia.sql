...
--
ALTER TABLE `rota_inscricao`
  ADD CONSTRAINT `fk_rota_inscricao_rota` FOREIGN KEY (`rota_id`) REFERENCES `rota` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_rota_inscricao_usuario` FOREIGN KEY (`usuario_id`) REFERENCES `usuario` (`id`) ON DELETE CASCADE;
COMMIT;
